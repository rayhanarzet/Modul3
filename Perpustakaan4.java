...
class BukuBaru {
    ...
    public BukuBaru(String judul, String penulis, String kategori, int tahun, String sinopsis) {
        this.judul = judul;
    ...
    BukuBaru salin() {
        return new BukuBaru(judul, penulis, kategori, tahun, sinopsis);
    }
}

public class Perpustakaan4 {
    public static void main(String[] args) {
        ArrayList<BukuBaru> daftarBuku = new ArrayList<>();
        ...
        BukuBaru bukuContoh = daftarBuku.get(0);
        double royalti = bukuContoh.hitungRoyalti(200000, 10);
        System.out.println("Royalti untuk buku '" + bukuContoh.judul + "' adalah Rp" + royalti);
    }
}
